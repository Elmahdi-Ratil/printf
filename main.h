...
va_list list, char buff[], int flg, int width, int pre, int size);
...
char buff[], int flg, char flag_ch, int width, int pre, int size);
...
int write_number(int is_positive, int ind, char buff[],
	int flg, int width, int pre, int size);
int write_num(int ind, char bff[], int flg, int width, int pre,
...
int is_digit(char);
/** CONVERT SIZE NUMBER AND UNSGND **/
